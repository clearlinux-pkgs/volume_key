...
Source0  : https://github.com/felixonmars/volume_key/archive/volume_key-0.3.11.tar.gz
Summary  : No detailed summary available
Group    : Development/Tools
License  : GPL-2.0
Requires: volume_key-bin
Requires: volume_key-python3
Requires: volume_key-lib
Requires: volume_key-license
...
%prep
%setup -q -n volume_key-volume_key-0.3.11
...
export LANG=C
export SOURCE_DATE_EPOCH=1532310661
...
export SOURCE_DATE_EPOCH=1532310661
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/volume_key
cp COPYING %{buildroot}/usr/share/doc/volume_key/COPYING
%make_install
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/volume_key/COPYING
